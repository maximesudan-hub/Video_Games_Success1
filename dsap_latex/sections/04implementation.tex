...
\paragraph{Outputs}
All metrics are saved to \texttt{results/metrics/} and figures to \texttt{results/figures/}. The main script prints a summary of model performance and writes CSV tables used in the report.
